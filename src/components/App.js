      ...
      <BrowserRouter>
        <div className="container">
          ...
          <Routes>
            ...
            <Route path="/ducks" element={ <PhotoContainer data={this.state.ducks} performSearch={this.performSearch} query={'ducks'} loading={this.state.loading} title='Photo Results for: Ducks'/> }/>
